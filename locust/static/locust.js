...
var responseTimeChart = new LocustLineChart($(".charts-container"), "Response Times (ms)", ["Median Response Time", "90% percentile", "99% percentile"], "ms");
...
function updateStats() {
    $.get('./stats/requests', function (report) {
        ...
        if (report.state !== "stopped"){
            ...
            responseTimeChart.addValue([report.current_response_time_percentile_50, report.current_response_time_percentile_90, report.current_response_time_percentile_99]);
